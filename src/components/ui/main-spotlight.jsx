  ...
  return (
    ...
    >
      <div
        className={cn(
          className,
          "group relative z-10 rounded-md  grid   lg:grid-cols-5 lg:gap-5 gap-1 grid-cols-3"
        )}
      >
        {children}
      </div>
    ...
    >
      ...
      {ProximitySpotlight && (
        <div
          ...
          style={{
            background: `radial-gradient(circle at ${mousePosition.x}px ${mousePosition.y}px, red 0%,transparent 20%,transparent) fixed`,
          }}
        ></div>
      )}
      {children}
