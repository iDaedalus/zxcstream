...
export default function Dash() {
  ...
  return (
    <>
      <main className=" min-h-[118vh] lg:pt-10 w-full bg-black flex">
        <Header />
        <section className="relative z-0 flex flex-1 flex-col items-center overflow-hidden justify-between bg-gradient-to-b from-black to-red-500/10">
          ...
          <div className="absolute top-0 isolate z-0 flex w-screen flex-1 items-start justify-center">
            ...
            {/* Main glow */}
            <div className="absolute inset-auto z-50 h-40 w-[28rem] -translate-y-[-30%] rounded-full bg-red-500/60 opacity-80 blur-3xl" />
            ...
            <motion.div
              ...
              className="absolute top-0 z-30 h-36 -translate-y-[20%] rounded-full bg-red-500/60 blur-2xl"
            />
            ...
            <motion.div
              ...
              transition={{ ease: "easeInOut", delay: 0.8, duration: 1.2 }}
              className="absolute inset-auto z-50 h-0.5 -translate-y-[-10%] bg-red-500/60"
            />
            ...
            <motion.div
              ...
              style={{
                backgroundImage:
                  "conic-gradient(from 80deg at center top, rgba(239,68,68,0.6), transparent, transparent)",
              }}
            ...
            <motion.div
              ...
              style={{
                backgroundImage:
                  "conic-gradient(from 280deg at center top, transparent, transparent, rgba(239,68,68,0.6))",
              }}
            ...
            <AnimatePresence mode="wait">
              {search.trim() !== "" && (
                ...
                >
                  <h2>
                    Search results for:{" "}
                    <span className="font-semibold text-red-800">{search}</span>
                  </h2>
                  <div>
